...
const TESTIMONIALS_DATA = [
  {
    id: "1",
    quote:
      "اطبخلي غيّر طريقة أكلنا بالبيت بشكل كامل. يخنة الشيف سميرة طعمها بالضبط متل أكل ستي، ما توقعت هيك شي من تطبيق!",
    author: "لينا سليمان",
    initials: "ل.س",
    verifiedTag: "✓ زبونة موثّقة",
    avatarBg: "bg-primary",
    rating: 5,
  },
  {
    id: "2",
    quote:
      "أنا موظف ودوامي طويل، وصراحة إني ألاقي أكل بيتي حقيقي عم يوصلني لباب البيت غيّر حياتي اليومية. كل طبق حاسس فيه إنه محضّر بمحبة.",
    author: "باسل الشامي",
    initials: "ب.ش",
    verifiedTag: "✓ زبون موثّق",
    avatarBg: "bg-secondary",
    rating: 5,
  },
  {
    id: "3",
    quote: "أحلى شي إنو بعرف مين اللي طبخلي بالضبط. شيش برك الشيف أبو عمر صار عادة أسبوعية عنا بالبيت.",
    author: "رهف النجار",
    initials: "ر.ن",
    verifiedTag: "✓ زبونة موثّقة",
